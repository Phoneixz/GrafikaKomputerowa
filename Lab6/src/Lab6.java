...
class Lab6 extends GLJPanel implements GLEventListener  {
    ...
    public void PyramidBaseOnCircle(GL2 gl2,int numVertices){
        ...
        for (int i = 1; i <= numVertices; i++) {
            ...
            gl2.glMaterialfv(GL2.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, materials[7], 4);
            gl2.glVertex3f( x, -2.0f, z );

            gl2.glMaterialfv(GL2.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, materials[7], 0);
            gl2.glVertex3f( 0.0f, 7.0f, 0.0f );

            angle = i * angleIncrement;

            gl2.glMaterialfv(GL2.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, materials[7], 8);
